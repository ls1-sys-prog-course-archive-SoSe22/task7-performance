...
class RocksDBOptionsParser {
	...
	static Status
	VerifyDBOptions(const DBOptions &base_opt, const DBOptions &new_opt,
	...
	static Status
	VerifyCFOptions(const ColumnFamilyOptions &base_opt,
	...
	static Status
	VerifyTableFactory(const TableFactory *base_tf,
	...
	static Status
	ExtraParserCheck(const RocksDBOptionsParser &input_parser);
	...
	Status
	EndSection(const OptionSection section, const std::string &title,
