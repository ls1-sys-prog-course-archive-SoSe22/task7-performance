...
class WinMmapReadableFile : private WinFileData, public RandomAccessFile {
	...
	WinMmapReadableFile(const std::string &fileName, HANDLE hFile,
			    HANDLE hMap, const void *mapped_region,
			    size_t length);
...
class WinRandomAccessFile
    ...
    public:
	WinRandomAccessFile(const std::string &fname, HANDLE hFile,
