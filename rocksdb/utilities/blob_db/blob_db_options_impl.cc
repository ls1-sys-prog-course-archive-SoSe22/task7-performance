...
BlobDBOptionsImpl::BlobDBOptionsImpl(const BlobDBOptions &in)
	: BlobDBOptions(in), deletion_check_period_millisecs(2 * 1000),
	  gc_file_pct(20), gc_check_period_millisecs(60 * 1000),
	  sanity_check_period_millisecs(20 * 60 * 1000),
	  open_files_trigger(100), wa_num_stats_periods(24),
	  wa_stats_period_millisecs(3600 * 1000),
	  partial_expiration_gc_range_secs(4 * 3600),
	  partial_expiration_pct(75), fsync_files_period_millisecs(10 * 1000),
...
BlobDBOptionsImpl::BlobDBOptionsImpl()
	: deletion_check_period_millisecs(2 * 1000), gc_file_pct(20),
...
BlobDBOptionsImpl &BlobDBOptionsImpl::operator=(const BlobDBOptionsImpl &in)
{
	...
	if (this != &in) {
		deletion_check_period_millisecs =
		...
		sanity_check_period_millisecs =
			in.sanity_check_period_millisecs;
		...
		partial_expiration_gc_range_secs =
			in.partial_expiration_gc_range_secs;
