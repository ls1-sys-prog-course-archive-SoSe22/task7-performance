...
class StackableDB : public DB {
	...
	{
		return db_->CreateColumnFamily(options, column_family_name,
					       handle);
	}
	...
	{
		return db_->CreateColumnFamilies(options, column_family_names,
						 handles);
	}
	...
	virtual Status
	DestroyColumnFamilyHandle(ColumnFamilyHandle *column_family) override
	{
	...
	{
		return db_->IngestExternalFile(column_family, external_files,
					       options);
	}
	...
	{
		return db_->KeyMayExist(options, column_family, key, value,
					value_found);
	}
	...
	virtual Iterator *
	NewIterator(const ReadOptions &opts,
	...
	virtual void
	GetApproximateSizes(ColumnFamilyHandle *column_family, const Range *r,
	...
	{
		return db_->CompactFiles(compact_options, column_family,
	...
	using DB::SetOptions;
	virtual Status
	SetOptions(ColumnFamilyHandle *column_family_handle,
	...
	GetPropertiesOfTablesInRange(ColumnFamilyHandle *column_family,
				     ...
				     TablePropertiesCollection *props) override
	{
		return db_->GetPropertiesOfTablesInRange(column_family, range,
							 n, props);
	}
