 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Checkpoint_newCheckpoint(JNIEnv *env, jclass jclazz,
						jlong jdb_handle)
{
						  ...
						  jstring jcheckpoint_path)
{
	const char *checkpoint_path =
		env->GetStringUTFChars(jcheckpoint_path, 0);
	...
	auto *checkpoint =
		reinterpret_cast<rocksdb::Checkpoint *>(jcheckpoint_handle);
