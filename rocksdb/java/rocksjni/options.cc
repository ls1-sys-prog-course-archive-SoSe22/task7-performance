 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setIncreaseParallelism(JNIEnv *env, jobject jobj,
						     jlong jhandle,
						     jint totalThreads)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setCreateIfMissing(JNIEnv *env, jobject jobj,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_createIfMissing(JNIEnv *env, jobject jobj,
						  jlong jhandle)
{
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setComparatorHandle__JI(JNIEnv *env, jobject jobj,
						      jlong jhandle,
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setComparatorHandle__JJ(JNIEnv *env, jobject jobj,
						      jlong jopt_handle,
 ...
 */
void Java_org_rocksdb_Options_setMergeOperatorName(JNIEnv *env, jobject jobj,
						   jlong jhandle,
						   jstring jop_name)
{
 ...
 * Signature: (JJjava/lang/String)V
 */
void Java_org_rocksdb_Options_setMergeOperator(JNIEnv *env, jobject jobj,
					       jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_writeBufferSize(JNIEnv *env, jobject jobj,
					       jlong jhandle)
{
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_Options_createStatistics(JNIEnv *env, jobject jobj,
					       jlong jOptHandle)
{
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_statisticsPtr(JNIEnv *env, jobject jobj,
					     jlong jOptHandle)
{
	auto *st = reinterpret_cast<rocksdb::Options *>(jOptHandle)
			   ->statistics.get();
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_maxWriteBufferNumber(JNIEnv *env, jobject jobj,
						   jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_errorIfExists(JNIEnv *env, jobject jobj,
						jlong jhandle)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setErrorIfExists(JNIEnv *env, jobject jobj,
					       jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_paranoidChecks(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setParanoidChecks(JNIEnv *env, jobject jobj,
						jlong jhandle,
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setEnv(JNIEnv *env, jobject jobj, jlong jhandle,
				     jlong jenv)
{
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setMaxTotalWalSize(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_maxTotalWalSize(JNIEnv *env, jobject jobj,
					       jlong jhandle)
{
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_maxFileOpeningThreads(JNIEnv *env, jobject jobj,
						    jlong jhandle)
{
					 ...
					 jlongArray jtarget_sizes)
{
	...
	jlong *ptr_jtarget_size =
		env->GetLongArrayElements(jtarget_sizes, nullptr);
	...
	for (jsize i = 0; i < len; i++) {
		jobject jpath = reinterpret_cast<jstring>(
			env->GetObjectArrayElement(jpaths, i));
		...
		db_paths.push_back(rocksdb::DbPath(
			path, static_cast<uint64_t>(jtarget_size)));
	}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_Options_dbPaths(JNIEnv *env, jobject jobj, jlong jhandle,
				      jobjectArray jpaths,
				      jlongArray jtarget_sizes)
{
	jlong *ptr_jtarget_size =
...
jstring Java_org_rocksdb_Options_dbLogDir(JNIEnv *env, jobject jobj,
					  jlong jhandle)
{
	return env->NewStringUTF(reinterpret_cast<rocksdb::Options *>(jhandle)
					 ->db_log_dir.c_str());
}
					  ...
					  jlong jhandle, jstring jdb_log_dir)
{
	...
	reinterpret_cast<rocksdb::Options *>(jhandle)->db_log_dir.assign(
		log_dir);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setDeleteObsoleteFilesPeriodMicros(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle,
								 jlong micros)
{
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setMaxSubcompactions(JNIEnv *env, jobject jobj,
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_maxSubcompactions(JNIEnv *env, jobject jobj,
						jlong jhandle)
{
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_maxBackgroundFlushes(JNIEnv *env, jobject jobj,
						   jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
...
{
	rocksdb::Status s =
		rocksdb::check_if_jlong_fits_size_t(max_log_file_size);
	if (s.ok()) {
		reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_logFileTimeToRoll(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setLogFileTimeToRoll(JNIEnv *env, jobject jobj,
						   jlong jhandle,
...
{
	rocksdb::Status s =
		rocksdb::check_if_jlong_fits_size_t(keep_log_file_num);
	if (s.ok()) {
		reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setRecycleLogFileNum(JNIEnv *env, jobject jobj,
						   jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_maxManifestFileSize(JNIEnv *env, jobject jobj,
						   jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (J)Ljava/lang/String
 */
jstring Java_org_rocksdb_Options_memTableFactoryName(JNIEnv *env, jobject jobj,
						     jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setMemTableFactory(JNIEnv *env, jobject jobj,
						 jlong jhandle,
						 jlong jfactory_handle)
{
	reinterpret_cast<rocksdb::Options *>(jhandle)->memtable_factory.reset(
		reinterpret_cast<rocksdb::MemTableRepFactory *>(
			jfactory_handle));
}
					     ...
					     jlong jrate_limiter_handle)
{
	...
	reinterpret_cast<rocksdb::Options *>(jhandle)->rate_limiter =
		*pRateLimiter;
}
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_tableCacheNumshardbits(JNIEnv *env, jobject jobj,
						     jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_useFixedLengthPrefixExtractor(JNIEnv *env,
							    jobject jobj,
							    jlong jhandle,
							    jint jprefix_length)
{
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setWalTtlSeconds(JNIEnv *env, jobject jobj,
					       jlong jhandle,
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setWalSizeLimitMB(JNIEnv *env, jobject jobj,
						jlong jhandle,
...
{
	rocksdb::Status s =
		rocksdb::check_if_jlong_fits_size_t(preallocation_size);
	if (s.ok()) {
		reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_allowMmapReads(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setAllowMmapReads(JNIEnv *env, jobject jobj,
						jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_allowMmapWrites(JNIEnv *env, jobject jobj,
						  jlong jhandle)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setAllowMmapWrites(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setAllowFAllocate(JNIEnv *env, jobject jobj,
						jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_allowFAllocate(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_isFdCloseOnExec(JNIEnv *env, jobject jobj,
						  jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
		->is_fd_close_on_exec;
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setIsFdCloseOnExec(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_statsDumpPeriodSec(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setStatsDumpPeriodSec(JNIEnv *env, jobject jobj,
						    jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_adviseRandomOnOpen(JNIEnv *env, jobject jobj,
						     jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setDbWriteBufferSize(JNIEnv *env, jobject jobj,
						   jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_dbWriteBufferSize(JNIEnv *env, jobject jobj,
						 jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_useAdaptiveMutex(JNIEnv *env, jobject jobj,
						   jlong jhandle)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setUseAdaptiveMutex(JNIEnv *env, jobject jobj,
						  jlong jhandle,
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setWalBytesPerSync(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_walBytesPerSync(JNIEnv *env, jobject jobj,
					       jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_setDelayedWriteRate(JNIEnv *env, jobject jobj,
						  jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_delayedWriteRate(JNIEnv *env, jobject jobj,
						jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setEnableWriteThreadAdaptiveYield(JNIEnv *env,
								jobject jobj,
								jlong jhandle,
								jboolean yield)
{
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_enableWriteThreadAdaptiveYield(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setWalRecoveryMode(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_walRecoveryMode(JNIEnv *env, jobject jobj,
					       jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
...
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
	auto *row_cache = reinterpret_cast<std::shared_ptr<rocksdb::Cache> *>(
		jrow_cache_handle);
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setDumpMallocStats(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_Options_dumpMallocStats(JNIEnv *env, jobject jobj,
						  jlong jhandle)
{
	auto *opt = reinterpret_cast<rocksdb::Options *>(jhandle);
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setCompressionType(JNIEnv *env, jobject jobj,
						 jlong jhandle,
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_compressionType(JNIEnv *env, jobject jobj,
					       jlong jhandle)
{
	auto *opts = reinterpret_cast<rocksdb::Options *>(jhandle);
...
rocksdb_compression_vector_helper(JNIEnv *env, jbyteArray jcompression_levels)
{
	...
	for (jsize i = 0; i < len; i++) {
		...
		compression_levels->push_back(
			static_cast<rocksdb::CompressionType>(jcl));
	}
	...
	JNIEnv *env, std::vector<rocksdb::CompressionType> compression_levels)
{
	...
	jbyteArray jcompression_levels =
		env->NewByteArray(static_cast<jsize>(len));
...
jlong Java_org_rocksdb_Options_maxCompactionBytes(JNIEnv *env, jobject jobj,
						  jlong jhandle)
{
	return static_cast<jlong>(reinterpret_cast<rocksdb::Options *>(jhandle)
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setMaxCompactionBytes(JNIEnv *env, jobject jobj,
						    jlong jhandle,
...
{
	rocksdb::Status s =
		rocksdb::check_if_jlong_fits_size_t(jarena_block_size);
	if (s.ok()) {
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_Options_optimizeForPointLookup(JNIEnv *env, jobject jobj,
						     jlong jhandle,
...
{
	jsize len =
		env->GetArrayLength(jmax_bytes_for_level_multiplier_additional);
	...
	JNIEnv *env, jobject jobj, jlong jhandle, jint builtinComparator)
{
	...
	case 1:
		reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
			->comparator = rocksdb::ReverseBytewiseComparator();
		break;
	default:
		reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
 ...
 * Signature: (JJjava/lang/String)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setMergeOperatorName(JNIEnv *env,
							       jobject jobj,
							       jlong jhandle,
							       jstring jop_name)
{
	...
	jlong jcompactionfilter_handle)
{
	reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jopt_handle)
		->compaction_filter =
		reinterpret_cast<rocksdb::CompactionFilter *>(
 ...
 * Signature: (J)Ljava/lang/String
 */
jstring Java_org_rocksdb_ColumnFamilyOptions_memTableFactoryName(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setTableFactory(JNIEnv *env,
							  jobject jobj,
							  jlong jhandle,
							  jlong jfactory_handle)
{
	...
	JNIEnv *env, jobject jobj, jlong jhandle)
{
	auto *cf_options =
		reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle);
	return rocksdb_compression_list_helper(
		env, cf_options->compression_per_level);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_maxTableFilesSizeFIFO(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_inplaceUpdateNumLocks(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setBloomLocality(JNIEnv *env,
							   jobject jobj,
							   jlong jhandle,
							   jint jbloom_locality)
{
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_ColumnFamilyOptions_level0StopWritesTrigger(JNIEnv *env,
								  jobject jobj,
								  jlong jhandle)
{
	return reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
	...
	jintArray jmax_bytes_for_level_multiplier_additional)
{
	jsize len =
		env->GetArrayLength(jmax_bytes_for_level_multiplier_additional);
	jint *additionals = env->GetIntArrayElements(
		jmax_bytes_for_level_multiplier_additional, 0);
	if (additionals == nullptr) {
		// exception thrown: OutOfMemoryError
		return;
	}
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_ColumnFamilyOptions_paranoidFileChecks(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::ColumnFamilyOptions *>(jhandle)
...
void Java_org_rocksdb_DBOptions_setCreateIfMissing(JNIEnv *env, jobject jobj,
						   jlong jhandle, jboolean flag)
{
	reinterpret_cast<rocksdb::DBOptions *>(jhandle)->create_if_missing =
		flag;
}
					       ...
					       jlong jrate_limiter_handle)
{
	std::shared_ptr<rocksdb::RateLimiter> *pRateLimiter =
		reinterpret_cast<std::shared_ptr<rocksdb::RateLimiter> *>(
			jrate_limiter_handle);
	reinterpret_cast<rocksdb::DBOptions *>(jhandle)->rate_limiter =
		*pRateLimiter;
}
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_DBOptions_createStatistics(JNIEnv *env, jobject jobj,
						 jlong jOptHandle)
{
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_DBOptions_statisticsPtr(JNIEnv *env, jobject jobj,
					       jlong jOptHandle)
{
					    ...
					    jlong jhandle, jstring jdb_log_dir)
{
	...
	reinterpret_cast<rocksdb::DBOptions *>(jhandle)->db_log_dir.assign(
		log_dir);
	env->ReleaseStringUTFChars(jdb_log_dir, log_dir);
}
...
jstring Java_org_rocksdb_DBOptions_dbLogDir(JNIEnv *env, jobject jobj,
					    jlong jhandle)
{
	return env->NewStringUTF(reinterpret_cast<rocksdb::DBOptions *>(jhandle)
					 ->db_log_dir.c_str());
}
					  ...
					  jlong jhandle, jstring jwal_dir)
{
	...
	reinterpret_cast<rocksdb::DBOptions *>(jhandle)->wal_dir.assign(
		wal_dir);
	env->ReleaseStringUTFChars(jwal_dir, wal_dir);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_DBOptions_deleteObsoleteFilesPeriodMicros(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::DBOptions *>(jhandle)
 ...
 * Signature: (JJ)V
 */
void Java_org_rocksdb_DBOptions_setRecycleLogFileNum(JNIEnv *env, jobject jobj,
						     jlong jhandle,
						     jlong recycle_log_file_num)
{
	rocksdb::Status s =
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_DBOptions_setIsFdCloseOnExec(JNIEnv *env, jobject jobj,
						   jlong jhandle,
						   jboolean is_fd_close_on_exec)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_DBOptions_setUseAdaptiveMutex(JNIEnv *env, jobject jobj,
						    jlong jhandle,
						    jboolean use_adaptive_mutex)
{
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_DBOptions_setAllowConcurrentMemtableWrite(JNIEnv *env,
								jobject jobj,
								jlong jhandle,
								jboolean allow)
{
 ...
 * Signature: (J)Z
 */
jboolean Java_org_rocksdb_DBOptions_allowConcurrentMemtableWrite(JNIEnv *env,
								 jobject jobj,
								 jlong jhandle)
{
	return reinterpret_cast<rocksdb::DBOptions *>(jhandle)
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_DBOptions_setDumpMallocStats(JNIEnv *env, jobject jobj,
						   jlong jhandle,
						   jboolean jdump_malloc_stats)
{
	auto *opt = reinterpret_cast<rocksdb::DBOptions *>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ReadOptions_setVerifyChecksums(JNIEnv *env, jobject jobj,
						     jlong jhandle,
...
jboolean Java_org_rocksdb_ReadOptions_verifyChecksums(JNIEnv *env, jobject jobj,
						      jlong jhandle)
{
	return reinterpret_cast<rocksdb::ReadOptions *>(jhandle)
		->verify_checksums;
}
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ReadOptions_setTotalOrderSeek(JNIEnv *env, jobject jobj,
						    jlong jhandle,
...
void Java_org_rocksdb_ReadOptions_setPinData(JNIEnv *env, jobject jobj,
					     jlong jhandle, jboolean jpin_data)
{
...
jboolean Java_org_rocksdb_ComparatorOptions_useAdaptiveMutex(JNIEnv *env,
							     ...
							     jlong jhandle)
{
	return reinterpret_cast<rocksdb::ComparatorJniCallbackOptions *>(
		       jhandle)
		->use_adaptive_mutex;
}
