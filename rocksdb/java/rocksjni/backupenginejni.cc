	...
	jboolean jflush_before_backup)
{
	...
	auto *backup_engine =
		reinterpret_cast<rocksdb::BackupEngine *>(jbe_handle);
 ...
 */
jobject Java_org_rocksdb_BackupEngine_getBackupInfo(JNIEnv *env, jobject jbe,
						    jlong jbe_handle)
{
	auto *backup_engine =
		reinterpret_cast<rocksdb::BackupEngine *>(jbe_handle);
						...
						jint jbackup_id)
{
	...
	auto status = backup_engine->DeleteBackup(
		static_cast<rocksdb::BackupID>(jbackup_id));
	...
	jstring jdb_dir, jstring jwal_dir, jlong jrestore_options_handle)
{
	...
	auto *restore_options = reinterpret_cast<rocksdb::RestoreOptions *>(
	...
	jstring jwal_dir, jlong jrestore_options_handle)
{
	...
	auto *restore_options = reinterpret_cast<rocksdb::RestoreOptions *>(
		jrestore_options_handle);
	auto status = backup_engine->RestoreDBFromLatestBackup(
 ...
 * Signature: (J)V
 */
void Java_org_rocksdb_BackupEngine_disposeInternal(JNIEnv *env, jobject jbe,
						   jlong jbe_handle)
{
