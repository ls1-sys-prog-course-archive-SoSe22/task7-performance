...
{
	Status s = Status::OK();
	if (static_cast<uint64_t>(jvalue) >
	    std::numeric_limits<size_t>::max()) {
		s = Status::InvalidArgument(
			Slice("jlong overflows 32 bit value."));
	}
	return s;
}
   ...
   */
	static jmethodID getSetNativeHandleMethod(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "setNativeHandle", "(JZ)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static bool ThrowNew(JNIEnv *env, const std::string &msg)
	{
		...
		if (jclazz == nullptr) {
			...
			std::cerr
				<< "JavaException::ThrowNew - Error: unexpected exception!"
				<< std::endl;
		...
		if (rs != JNI_OK) {
			...
			std::cerr
				<< "JavaException::ThrowNew - Fatal: could not throw exception!"
				<< std::endl;
			return env->ExceptionCheck();
		}
...
class StatusJni : public RocksDBNativeClass<rocksdb::Status *, StatusJni> {
   ...
   */
	static jobject construct(JNIEnv *env, const Status &status)
	{
		...
		jobject jstatus = env->NewObject(
			jclazz, mid, toJavaStatusCode(status.code()),
	...
	static jbyte
	toJavaStatusSubCode(const rocksdb::Status::SubCode &subCode)
	{
		switch (subCode) {
   ...
   */
	static bool ThrowNew(JNIEnv *env, const Status &s)
	{
		...
		jthrowable rocksdb_exception = reinterpret_cast<jthrowable>(
			env->NewObject(jclazz, mid, jstatus));
		if (env->ExceptionCheck()) {
			if (jstatus != nullptr) {
			...
			std::cerr
				<< "RocksDBExceptionJni::ThrowNew/NewObject - Error: unexpected exception!"
				<< std::endl;
			return true;
		}
   ...
   */
			     ...
			     const Status &s)
	{
		...
		jmethodID mid = env->GetMethodID(
			jclazz, "<init>",
			"(Ljava/lang/String;Lorg/rocksdb/Status;)V");
		if (mid == nullptr) {
			// exception thrown: NoSuchMethodException or OutOfMemoryError
			std::cerr
				<< "RocksDBExceptionJni::ThrowNew/cstr - Error: unexpected exception!"
   ...
   */
	static bool ThrowNew(JNIEnv *env, const Status &s)
	{
		...
		if (jclazz == nullptr) {
			// exception occurred accessing class
			std::cerr
				<< "IllegalArgumentExceptionJni::ThrowNew/class - Error: unexpected exception!"
				<< std::endl;
			return env->ExceptionCheck();
		}
...
class OptionsJni : public RocksDBNativeClass<rocksdb::Options *, OptionsJni> {
    public:
	/**
...
class DBOptionsJni
	: public RocksDBNativeClass<rocksdb::DBOptions *, DBOptionsJni> {
    public:
	/**
   ...
   */
	static jclass getJClass(JNIEnv *env)
	{
		return JavaClass::getJClass(
			env, "org/rocksdb/ColumnFamilyDescriptor");
	}
   ...
   */
	static jclass getJClass(JNIEnv *env)
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/ColumnFamilyOptions");
	}
};

// The portal class for org.rocksdb.WriteOptions
class WriteOptionsJni
	: public RocksDBNativeClass<rocksdb::WriteOptions *, WriteOptionsJni> {
    public:
	/**
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/WriteOptions");
	}
};

// The portal class for org.rocksdb.ReadOptions
class ReadOptionsJni
	: public RocksDBNativeClass<rocksdb::ReadOptions *, ReadOptionsJni> {
    public:
	/**
...
class WriteBatchJni
	: public RocksDBNativeClass<rocksdb::WriteBatch *, WriteBatchJni> {
    public:
	/**
...
class WriteBatchHandlerJni
	: public RocksDBNativeClass<const rocksdb::WriteBatchHandlerJniCallback *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/WriteBatch$Handler");
	}
   ...
   */
	static jmethodID getPutMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "put", "([B[B)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getMergeMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "merge", "([B[B)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getDeleteMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "delete", "([B)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getDeleteRangeMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "deleteRange", "([B[B)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getLogDataMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "logData", "([B)V");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getContinueMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "shouldContinue", "()Z");
		assert(mid != nullptr);
		return mid;
	}
};
...
class WriteBatchWithIndexJni
	: public RocksDBNativeClass<rocksdb::WriteBatchWithIndex *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/WriteBatchWithIndex");
	}
};
...
class HistogramDataJni : public JavaClass {
   ...
   */
	static jmethodID getConstructorMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "<init>", "(DDDDD)V");
		assert(mid != nullptr);
		return mid;
	}
};
...
class BackupableDBOptionsJni
	: public RocksDBNativeClass<rocksdb::BackupableDBOptions *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/BackupableDBOptions");
	}
};

// The portal class for org.rocksdb.BackupEngine
class BackupEngineJni
	: public RocksDBNativeClass<rocksdb::BackupEngine *, BackupEngineJni> {
    public:
	/**
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/BackupEngine");
	}
};

// The portal class for org.rocksdb.RocksIterator
class IteratorJni
	: public RocksDBNativeClass<rocksdb::Iterator *, IteratorJni> {
    public:
	/**
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/RocksIterator");
	}
};

// The portal class for org.rocksdb.Filter
class FilterJni
	: public RocksDBNativeClass<std::shared_ptr<rocksdb::FilterPolicy> *,
				    FilterJni> {
    public:
	/**
...
class ColumnFamilyHandleJni
	: public RocksDBNativeClass<rocksdb::ColumnFamilyHandle *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/ColumnFamilyHandle");
	}
};

// The portal class for org.rocksdb.FlushOptions
class FlushOptionsJni
	: public RocksDBNativeClass<rocksdb::FlushOptions *, FlushOptionsJni> {
    public:
	/**
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/FlushOptions");
	}
};

// The portal class for org.rocksdb.ComparatorOptions
class ComparatorOptionsJni
	: public RocksDBNativeClass<rocksdb::ComparatorJniCallbackOptions *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/ComparatorOptions");
	}
};

// The portal class for org.rocksdb.AbstractComparator
class AbstractComparatorJni
	: public RocksDBNativeClass<const rocksdb::BaseComparatorJniCallback *,
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/AbstractComparator");
	}
   ...
   */
	static jmethodID getNameMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid = env->GetMethodID(jclazz, "name",
							"()Ljava/lang/String;");
		assert(mid != nullptr);
		return mid;
	}
...
class AbstractSliceJni : public NativeRocksMutableObject<const rocksdb::Slice *,
							 AbstractSliceJni> {
    public:
	/**
   ...
   */
	...
	{
		return RocksDBNativeClass::getJClass(
			env, "org/rocksdb/AbstractSlice");
	}
};

// The portal class for org.rocksdb.Slice
class SliceJni : public NativeRocksMutableObject<const rocksdb::Slice *,
						 AbstractSliceJni> {
    public:
	/**
...
class DirectSliceJni : public NativeRocksMutableObject<const rocksdb::Slice *,
						       AbstractSliceJni> {
    public:
	/**
...
class ListJni : public JavaClass {
   ...
   */
	static jmethodID getIteratorMethod(JNIEnv *env)
	{
		...
		static jmethodID mid = env->GetMethodID(
			jlist_clazz, "iterator", "()Ljava/util/Iterator;");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getHasNextMethod(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jiterator_clazz, "hasNext", "()Z");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getNextMethod(JNIEnv *env)
	{
		...
		static jmethodID mid = env->GetMethodID(jiterator_clazz, "next",
							"()Ljava/lang/Object;");
		assert(mid != nullptr);
		return mid;
	}
   ...
   */
	static jmethodID getListAddMethodId(JNIEnv *env)
	{
		...
		static jmethodID mid = env->GetMethodID(
			jlist_clazz, "add", "(Ljava/lang/Object;)Z");
		assert(mid != nullptr);
		return mid;
	}
};
...
class ByteJni : public JavaClass {
   ...
   */
	static jmethodID getByteValueMethod(JNIEnv *env)
	{
		...
		static jmethodID mid =
			env->GetMethodID(clazz, "byteValue", "()B");
		assert(mid != nullptr);
		return mid;
	}
};
...
class StringBuilderJni : public JavaClass {
   ...
   */
			      ...
			      const char *c_str)
	{
		...
		jobject jresult_string_builder = env->CallObjectMethod(
			jstring_builder, mid, new_value_str);
		if (env->ExceptionCheck()) {
			// exception occurred
...
class BackupInfoJni : public JavaClass {
   ...
   *     exception occurs
   */
	static jobject construct0(JNIEnv *env, uint32_t backup_id,
				  int64_t timestamp, uint64_t size,
				  uint32_t number_files)
	{
		...
		static jmethodID mid =
			env->GetMethodID(jclazz, "<init>", "(IJJI)V");
		if (mid == nullptr) {
			// exception occurred accessing method
			return nullptr;
		}

		jobject jbackup_info = env->NewObject(
			jclazz, mid, backup_id, timestamp, size, number_files);
		if (env->ExceptionCheck()) {
			return nullptr;
		}
   ...
   */
				     ...
				     std::vector<BackupInfo> backup_infos)
	{
		jclass jarray_list_clazz =
			rocksdb::ListJni::getArrayListClass(env);
		if (jarray_list_clazz == nullptr) {
			// exception occurred accessing class
			return nullptr;
		}
		...
		jmethodID cstr_mid =
			rocksdb::ListJni::getArrayListConstructorMethodId(env);
		if (cstr_mid == nullptr) {
			// exception occurred accessing method
			return nullptr;
		}
		...
		// create java list
		jobject jbackup_info_handle_list = env->NewObject(
			jarray_list_clazz, cstr_mid, backup_infos.size());
		if (env->ExceptionCheck()) {
		...
		for (auto it = backup_infos.begin(); it != end; ++it) {
			...
			jobject obj = rocksdb::BackupInfoJni::construct0(
				env, backup_info.backup_id,
				backup_info.timestamp, backup_info.size,
			...
			if (env->ExceptionCheck()) {
				...
				if (jbackup_info_handle_list != nullptr) {
					env->DeleteLocalRef(
						jbackup_info_handle_list);
				}
				return nullptr;
			}

			jboolean rs = env->CallBooleanMethod(
				jbackup_info_handle_list, add_mid, obj);
...
class WBWIRocksIteratorJni : public JavaClass {
   ...
   */
	static jobject getWriteEntry(JNIEnv *env, jobject jwbwi_rocks_iterator)
	{
		...
		jobject jwe = env->GetObjectField(jwbwi_rocks_iterator,
						  jwrite_entry_field);
		assert(jwe != nullptr);
		return jwe;
	}
...
class WriteTypeJni : public JavaClass {
   ...
   */
	...
	{
		return JavaClass::getJClass(
			env, "org/rocksdb/WBWIRocksIterator$WriteType");
	}
...
class WriteEntryJni : public JavaClass {
   ...
   */
	...
	{
		return JavaClass::getJClass(
			env, "org/rocksdb/WBWIRocksIterator$WriteEntry");
	}
};
...
class InfoLogLevelJni : public JavaClass {
   ...
   */
	static jobject getEnum(JNIEnv *env, const char name[])
	{
		...
		jfieldID jfid = env->GetStaticFieldID(
			jclazz, name, "Lorg/rocksdb/InfoLogLevel;");
		if (env->ExceptionCheck()) {
			// exception occurred while getting field
			return nullptr;
		} else if (jfid == nullptr) {
		...
		jobject jinfo_log_level =
			env->GetStaticObjectField(jclazz, jfid);
   ...
   */
				 ...
				 rocksdb::BatchResult &batch_result)
	{
		...
		jobject jbatch_result =
			env->NewObject(jclazz, mid, batch_result.sequence,
...
class CompactionStopStyleJni {
	...
	static rocksdb::CompactionStopStyle
	toCppCompactionStopStyle(jbyte jcompaction_stop_style)
	{
		switch (jcompaction_stop_style) {
		case 0x0:
			return rocksdb::CompactionStopStyle::
...
class CompressionTypeJni {
	...
	static jbyte
	toJavaCompressionType(const rocksdb::CompressionType &compression_type)
	{
	...
	toCppCompressionType(jbyte jcompression_type)
	{
...
class CompactionPriorityJni {
	...
	static rocksdb::CompactionPri
	toCppCompactionPriority(jbyte jcompaction_priority)
	{
...
class AccessHintJni {
	...
	static jbyte
	toJavaAccessHint(const rocksdb::DBOptions::AccessHint &access_hint)
	{
		switch (access_hint) {
	...
	static rocksdb::DBOptions::AccessHint
	toCppAccessHint(jbyte jaccess_hint)
	{
		switch (jaccess_hint) {
		case 0x0:
...
class WALRecoveryModeJni {
	...
	static jbyte
	toJavaWALRecoveryMode(const rocksdb::WALRecoveryMode &wal_recovery_mode)
	{
	...
	toCppWALRecoveryMode(jbyte jwal_recovery_mode)
	{
...
class JniUtil {
	...
	static JNIEnv *getJniEnv(JavaVM *jvm, jboolean *attached)
	{
		...
		if (env_rs == JNI_OK) {
			...
			*attached = JNI_FALSE;
			...
			std::cerr
				<< "JniUtil::getJinEnv - Fatal: Unknown error: env_rs="
				<< env_rs << std::endl;
			return nullptr;
		}
	}
	...
	static void releaseJniEnv(JavaVM *jvm, jboolean &attached)
	{
		...
		if (attached == JNI_TRUE) {
			...
			if (rs_detach != JNI_OK) {
				std::cerr
					<< "JniUtil::getJinEnv - Warn: Unable to detach current thread from JVM!"
					<< std::endl;
			}
		}
	}
	...
	copyStrings(JNIEnv *env, jobjectArray jss, jboolean *has_exception)
	{
		return rocksdb::JniUtil::copyStrings(
	...
	template <typename T>
	static void
	byteStrings(JNIEnv *env, jobjectArray jbyte_strings,
		    ...
		    jboolean *has_exception)
	{
		...
		for (jsize i = 0; i < jlen; i++) {
			jobject jbyte_string_obj =
				env->GetObjectArrayElement(jbyte_strings, i);
			if (env->ExceptionCheck()) {
				// exception thrown: ArrayIndexOutOfBoundsException
			...
			T result = byteString(env, jbyte_string_ary, string_fn,
					      has_exception);
	...
	template <typename T>
	static T
	byteString(JNIEnv *env, jbyteArray jbyte_string_ary,
		   std::function<T(const char *, const size_t)> string_fn,
		   jboolean *has_exception)
	{
		const jsize jbyte_string_len =
			env->GetArrayLength(jbyte_string_ary);
		jbyte *jbyte_string =
		...
		T result = string_fn(reinterpret_cast<char *>(jbyte_string),
				     jbyte_string_len);

		env->ReleaseByteArrayElements(jbyte_string_ary, jbyte_string,
					      JNI_ABORT);
					 ...
					 std::vector<std::string> strings)
	{
		...
		jobjectArray jbyte_strings =
			env->NewObjectArray(len, jcls_ba, nullptr);
		...
		for (jsize i = 0; i < len; i++) {
			...
			env->SetObjectArrayElement(jbyte_strings, i,
						   jbyte_string_ary);
			if (env->ExceptionCheck()) {
				// exception thrown: ArrayIndexOutOfBoundsException
     ...
     */
	static void
	kv_op(std::function<void(rocksdb::Slice, rocksdb::Slice)> op,
	      ...
	      jbyteArray jentry_value, jint jentry_value_len)
	{
		...
		if (env->ExceptionCheck()) {
			// exception thrown: OutOfMemoryError
			if (key != nullptr) {
				env->ReleaseByteArrayElements(jkey, key,
							      JNI_ABORT);
			}
			return;
		}
		...
		if (value != nullptr) {
			env->ReleaseByteArrayElements(jentry_value, value,
						      JNI_ABORT);
		}
		if (key != nullptr) {
     ...
     */
	static void k_op(std::function<void(rocksdb::Slice)> op, JNIEnv *env,
			 jobject jobj, jbyteArray jkey, jint jkey_len)
	{
		jbyte *key = env->GetByteArrayElements(jkey, nullptr);
		if (env->ExceptionCheck()) {
			// exception thrown: OutOfMemoryError
     ...
     */
	static jbyteArray
	v_op(std::function<rocksdb::Status(rocksdb::Slice, std::string *)> op,
	     JNIEnv *env, jbyteArray jkey, jint jkey_len)
	{
		...
		if (s.ok()) {
			jbyteArray jret_value = env->NewByteArray(
