...
#define IOSTATS_ADD(metric, value) (get_iostats_context()->metric += value)
...
#define IOSTATS_RESET(metric) (get_iostats_context()->metric = 0)

// reset all counters to zero
#define IOSTATS_RESET_ALL() (get_iostats_context()->Reset())

#define IOSTATS_SET_THREAD_POOL_ID(value)                                      \
	(get_iostats_context()->thread_pool_id = value)

#define IOSTATS_THREAD_POOL_ID() (get_iostats_context()->thread_pool_id)

#define IOSTATS(metric) (get_iostats_context()->metric)
