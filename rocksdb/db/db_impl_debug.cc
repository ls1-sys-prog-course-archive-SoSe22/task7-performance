...
int64_t
DBImpl::TEST_MaxNextLevelOverlappingBytes(ColumnFamilyHandle *column_family)
{
...
Status
DBImpl::TEST_GetLatestMutableCFOptions(ColumnFamilyHandle *column_family,
