...
class CompactionPicker {
	...
	virtual Compaction *
	PickCompaction(const std::string &cf_name,
	...
	virtual Compaction *
	CompactRange(const std::string &cf_name,
		     const MutableCFOptions &mutable_cf_options,
	...
	virtual bool
	NeedsCompaction(const VersionStorageInfo *vstorage) const = 0;
...
#ifndef ROCKSDB_LITE
	Status
	SanitizeCompactionInputFiles(std::unordered_set<uint64_t> *input_files,
...
class LevelCompactionPicker : public CompactionPicker {
	...
	virtual bool
	NeedsCompaction(const VersionStorageInfo *vstorage) const override;
};
