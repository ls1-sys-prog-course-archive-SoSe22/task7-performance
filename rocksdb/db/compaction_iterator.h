...
class CompactionIterator {
	...
	class CompactionProxy {
		...
		{
			return compaction_->KeyNotExistsBeyondOutputLevel(
				user_key, level_ptrs);
		}
		...
		{
			return compaction_->number_levels();
		}
	...
	const CompactionIterationStats &iter_stats() const
	{
		return iter_stats_;
	}
	...
	findEarliestVisibleSnapshot(SequenceNumber in,
